    ...
    try:
        ...
        if video_mode == 'final':
            ...
            if not follow_2d_bboxes:
                if log_callback:
                    log_callback(
                        f"Error: {video_mode} mode requires follow_2d_bboxes_per_frame in "
            ...
            if video_mode == 'follow_3d_rotate':
                ...
                # (they are a strict superset), so caching normal bboxes separately
                # would be redundant.  Only bg images are used during frame generation.
                bg_bboxes = (
